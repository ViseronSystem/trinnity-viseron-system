...
const ACCENT = "#34d399";
const TITLE = "VISERON OS Mobile";
const TAGLINE = "VISERON OS: Control, Insight, Apps";
const FEATURES = ["Unified Launcher for VISERON OS","Direct Access to Command Center","VISERON HUD for Seamless Navigation"];
