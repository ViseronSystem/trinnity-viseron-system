...
const T: Record<string, any> = {
  pt: {
    ...
    m1: "O Viseron Cosmos nasceu do Trinnity Viseron System (TVS): 5.000+ mentes de IA autónomas. $VSR é a coroa (governança, 300M) e $TRIN é a moeda de viagem interplanetária (420.69M). Ethereum · BSC · Solana. A comunidade decide o destino do universo.",
    m2t: "PÚBLICO-ALVO",
    ...
    posts: [
      ...
      ["🌌", "$TRIN — a moeda de viagem do batallón. 420.69M. Burn 2%. A ELON do Trinnity Viseron System. Únete a la misión."],
    ...
    m5: "Trinnity Viseron System, o sistema operativo multi-agente de IA com 5.000+ mentes autónomas, anuncia o lançamento do Viseron Cosmos: duas moedas nativas — $VSR (governança, 300M, 1% burn, anti-whale 3%) e $TRIN (memecoin interplanetária, 420.69M, 2% burn, anti-bot). Ambas em Ethereum, BSC e Solana, com staking, governança on-chain, metaverso jogável e roadmap para exchanges. © Pedro Costa (Comandante) · Trinnity Hurtado (Rainha).",
  ...
  es: {
    ...
    m1t: "MENSAJE CENTRAL",
    m1: "Viseron Cosmos nació del Trinnity Viseron System (TVS): 5.000+ mentes de IA autónomas. $VSR es la corona (gobernanza, 300M) y $TRIN la moneda de viaje interplanetaria (420.69M). Ethereum · BSC · Solana. La comunidad decide el destino del universo.",
    ...
    posts: [
      ...
      ["🌌", "$TRIN — la moneda de viaje del batallón. 420.69M. Burn 2%. La ELON del Trinnity Viseron System. Únete a la misión."],
    ...
    m5: "Trinnity Viseron System, el sistema operativo multi-agente de IA con 5.000+ mentes autónomas, anuncia el lanzamiento de Viseron Cosmos: dos monedas nativas — $VSR (gobernanza, 300M, 1% burn, anti-whale 3%) y $TRIN (memecoin interplanetaria, 420.69M, 2% burn, anti-bot). Ambas en Ethereum, BSC y Solana, con staking, gobernanza on-chain, metaverso jugable y roadmap hacia exchanges. © Pedro Costa (Comandante) · Trinnity Hurtado (Rainha).",
  ...
  en: {
    ...
    m1t: "CORE MESSAGE",
    m1: "Viseron Cosmos was born from the Trinnity Viseron System (TVS): 5,000+ autonomous AI minds. $VSR is the crown (governance, 300M) and $TRIN is the interplanetary travel coin (420.69M). Ethereum · BSC · Solana. The community decides the universe's destiny.",
    m2t: "TARGET AUDIENCE",
    ...
    posts: [
      ...
      ["🌌", "$TRIN — the battalion's travel coin. 420.69M. 2% burn. The ELON of the Trinnity Viseron System. Join the mission."],
    ...
    m5: "Trinnity Viseron System, the multi-agent AI operating system with 5,000+ autonomous minds, announces the launch of Viseron Cosmos: two native coins — $VSR (governance, 300M, 1% burn, 3% anti-whale) and $TRIN (interplanetary memecoin, 420.69M, 2% burn, anti-bot). Both on Ethereum, BSC and Solana, with staking, on-chain governance, a playable metaverse and an exchange roadmap. © Pedro Costa (Comandante) · Trinnity Hurtado (Rainha).",
